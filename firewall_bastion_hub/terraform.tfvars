...
firewall_subnet_address_prefixes = ["10.0.2.0/24"]
...
# Resource Groups
hub_rg_name     = "ns-cc-corp-shs-prod-core_hub-vnet-rg"
firewall_rg_name = "ns-cc-corp-shs-prod-core_hub-fw-rg"
dns_rg_name      = "ns-cc-corp-shs-prod-dns-rg"
bastion_rg_name  = "ns-cc-corp-shs-prod-bastion-rg"

# Network Security Groups
hub_nsg_name        = "ns-cc-corp-shs-prod-core_hub-nsg"
dns_bastion_nsg_name = "ns-cc-corp-shs-prod-dns_bastion-nsg"

# Route Tables
hub_route_table_name        = "ns-cc-corp-shs-prod-core_hub-rt"
dns_bastion_route_table_name = "ns-cc-corp-shs-prod-dns_bastion-rt"

# Hub VNET
hub_vnet_name        = "ns-cc-corp-shs-prod-core_hub-vnet"
...
# DNS/Bastion VNET
dns_bastion_vnet_name = "ns-cc-corp-shs-prod-dns_bastion-vnet"
dns_bastion_vnet_address_space = ["10.0.2.0/23", "10.0.4.0/24"]
dns_resolver_inbound_subnet_address_prefixes = ["10.0.2.0/28"]
dns_resolver_outbound_subnet_address_prefixes = ["10.0.2.16/28"]
bastion_subnet_address_prefixes = ["10.0.3.0/24"]

# Firewall
firewall_name = "ns-cc-corp-shs-prod-core_hub-fw"
firewall_sku_tier = "Standard"
firewall_policy_name = "ns-cc-corp-shs-prod-core_hub-fwpp"
firewall_policy_sku_tier = "Standard"

# DNS Resolver
dns_resolver_name = "ns-cc-corp-shs-prod-dns_resolver"

# Bastion
bastion_name = "ns-cc-corp-shs-prod-bastion"
